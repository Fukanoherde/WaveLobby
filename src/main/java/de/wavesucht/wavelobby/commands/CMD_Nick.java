...
public class CMD_Nick implements CommandExecutor {
    ...
    public CMD_Nick (WaveLobby plugin) {
        this.plugin = plugin;
                    ...
                    if (args.length == 3) {
                        ...
                        if (args[2].equalsIgnoreCase("true")) {
                            if (AllowOP.playerExists(target.getUniqueId().toString())) {
                                NickAPI.setNicked(target.getUniqueId().toString(), target.getName(), Integer.valueOf(1));
                            ...
                            if (NickAPI.playerExists(target.getUniqueId().toString())) {
                                NickAPI.setNicked(target.getUniqueId().toString(), target.getName(), Integer.valueOf(0));
